export const acknowledgementTemplate = (volunteerName, organizationName) => `
...
<p>You're Invited, ${volunteerName}!</p>
...
export const confirmationEmail = (volunteerName, eventName) => `
